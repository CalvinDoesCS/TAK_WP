...
use Modules\AccountingCore\App\Http\Controllers\SettingsController;
...
Route::prefix('accountingcore')->name('accountingcore.')->middleware(['auth', 'web'])->group(function () {
    ...
    Route::prefix('transactions')->name('transactions.')->group(function () {
        ...
        Route::get('/{id}/attachment/download', [TransactionController::class, 'downloadAttachment'])->name('download-attachment');
    });
