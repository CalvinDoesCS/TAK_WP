...
@section('page-script')
  @vite(['resources/assets/js/app/compensatory-off.js'])
@endsection
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row mb-4">
      <div class="col-xl-3 col-lg-6 col-md-6">
        <div class="card h-100" data-stat="total_earned">
      ...
      <div class="col-xl-3 col-lg-6 col-md-6">
        <div class="card h-100" data-stat="available">
          <div class="card-header d-flex align-items-center justify-content-between">
            <div class="card-title mb-0">
      ...
      <div class="col-xl-3 col-lg-6 col-md-6">
        <div class="card h-100" data-stat="used">
          <div class="card-header d-flex align-items-center justify-content-between">
            <div class="card-title mb-0">
      ...
      <div class="col-xl-3 col-lg-6 col-md-6">
        <div class="card h-100" data-stat="expired">
          <div class="card-header d-flex align-items-center justify-content-between">
            <div class="card-title mb-0">
      ...
      <div class="card-body">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-3">
            ...
            <select id="usageFilter" name="usageFilter" class="form-select select2">
    ...
    <script>
      const pageData = {
        ...
        labels: {
          ...
          confirmApprove: @json(__('Approve Compensatory Off?')),
          approvalNotes: @json(__('Approval Notes')),
          confirmReject: @json(__('Reject Compensatory Off?')),
          rejectionReason: @json(__('Rejection Reason')),
          reasonRequired: @json(__('Reason is required')),
          confirmDelete: @json(__('Delete Compensatory Off?')),
          deleteWarning: @json(__('This action cannot be undone.')),
          confirmMarkUsed: @json(__('Mark as Used?')),
          markUsedWarning: @json(__('This will mark the compensatory off as used.')),
