...
class CurrentProbationSheet implements FromQuery, ShouldAutoSize, WithEvents, WithHeadings, WithMapping, WithStyles, WithTitle
{
    protected $filters;
    ...
    {
        $daysRemaining = $user->probation_end_date
            ? now()->diffInDays($user->probation_end_date, false)
            : 0;
        ...
        return [
            ...
            $daysRemaining > 0 ? number_format($daysRemaining) : 'Overdue',
        ];
    }
