...
class ProbationOutcomesSheet implements FromQuery, ShouldAutoSize, WithEvents, WithHeadings, WithMapping, WithStyles, WithTitle
{
    protected $filters;
    ...
    public function query()
    {
        return User::query()
            ...
            ->orderByDesc('probation_confirmed_at')
            ->limit(100);
    }
