        ...
        <div class="leave-details">
          ...
          <div class="row mb-3">
            <div class="col-6">
              ...
              <p class="mb-0">${leave.from_date}</p>
            </div>
            <div class="col-6">
              <label class="form-label text-muted small">To Date</label>
              <p class="mb-0">${leave.to_date}</p>
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <p class="mb-0">
              <a href="/storage/${leave.document}" target="_blank" class="btn btn-sm btn-label-primary">
          ...
          <div class="mb-3">
            ...
            <p class="mb-0">${formatDateTime(leave.created_at)}</p>
          </div>
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      $.ajax({
        ...
        error: function(xhr) {
          let message = 'Failed to cancel leave request';
