      ...
      <div class="col-xl-8 col-lg-10 col-md-12">
        <div class="card">
          ...
          <form id="leaveApplicationForm" method="POST" action="{{ route('hrcore.my.leaves.store') }}" enctype="multipart/form-data">
            ...
            {{-- @unless(auth()->user()->can('hrcore.create-leave-for-others')) --}} {{-- PERMISSION TEMPORARILY DISABLED --}}
            ...
            <div class="card-body">
              ...
              <div class="mb-3" id="comp_off_section" style="display: none;">
                <div class="card bg-label-success">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <div>
                        <h6 class="mb-1">{{ __('Compensatory Off Available') }}</h6>
                        <p class="mb-0 text-muted small">{{ __('You have comp off balance that can be used') }}</p>
                      </div>
                      <div class="text-end">
                    ...
                    <div class="form-check form-switch">
                      ...
                      <label class="form-check-label" for="use_comp_off">
                        {{ __('Use Compensatory Off for this leave') }}
                      </label>
                    </div>
                      ...
                      <div class="alert alert-primary mb-0">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                            ...
                            <span>{{ __('Comp Off Days to Use') }}: <strong id="comp_off_days_used">0</strong></span>
                          </div>
                          <div>
                            <span>{{ __('Leave Balance Used') }}: <strong id="leave_balance_used">0</strong></span>
                          </div>
                        </div>
                      </div>
                    </div>
