...
@section('content')
    ...
    <div class="row mb-4">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            @php
              $todayAttendance = $attendances->first(fn($att) => $att->date->isToday());
            @endphp
                ...
                <div class="col-md-3">
                  <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                      ...
                      @php
                        $todayHours = floor($todayAttendance->working_hours ?? 0);
                        $todayMinutes = round((($todayAttendance->working_hours ?? 0) - $todayHours) * 60);
                      @endphp
                      <strong>
                        @if($todayHours > 0)
                ...
                <tr>
                  ...
                  <td>
                    @if($attendance->overtime_hours > 0)
                      @php
                        $otHours = floor($attendance->overtime_hours);
                        $otMinutes = round(($attendance->overtime_hours - $otHours) * 60);
                      @endphp
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="viewDetailsOffcanvas" aria-labelledby="viewDetailsOffcanvasLabel">
    <div class="offcanvas-header">
      <h5 class="offcanvas-title" id="viewDetailsOffcanvasLabel">{{ __('Attendance Details') }}</h5>
