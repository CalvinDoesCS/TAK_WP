...
@section('content')
  <div class="auth-wrapper">
    <div class="auth-container">
      ...
      <!-- Verify Email Card -->
      <div class="auth-card">
        <h2 class="auth-title">@lang('Verify your email') ✉️</h2>
        <p class="auth-subtitle">
          @lang('Account activation link sent to your email address:')<br>
          <span class="highlight-email">{{auth()->user()->email}}</span><br>
