    ...
    function walkDirectory(currentPath) {
        ...
        for (const file of files) {
            ...
            if (stats.isFile() && !file.startsWith('.')) {
                const relativePath = 'Modules/MultiTenancyCore/' + relative(__dirname, filePath);
...
export default defineConfig({
    build: {
        outDir: '../../public/build-multitenancycore',
        emptyOutDir: true,
        manifest: true,
    },
    plugins: [
        laravel({
            ...
            buildDirectory: 'build-multitenancycore',
            input: [
...
//    'Modules/MultiTenancyCore/resources/assets/js/app.js',
//];
