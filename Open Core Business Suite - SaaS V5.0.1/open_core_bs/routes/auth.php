...
Route::middleware('web')->group(function () {
    ...
    // Registration routes redirected to MultiTenancyCore module
    ...
    Route::get('/email/verify/{id}/{hash}', function (EmailVerificationRequest $request) {
        ...
        if ($request->user()->hasRole('tenant')) {
            return redirect()->route('multitenancycore.tenant.dashboard')->with('success', 'Email verified, welcome to the platform!');
        }
