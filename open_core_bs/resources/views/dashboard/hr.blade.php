        ...
        <div class="row mb-4">
            ...
            @if(isset($finance['loans']) && $finance['loans']['enabled'])
                <x-dashboard.stat-card
                    ...
                    icon="bx-dollar"
                    iconColor="warning"
                    :url="\Illuminate\Support\Facades\Route::has('loan.index') ? route('loan.index') : null"
                />
            @endif
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="list-group">
                        ...
                        @endif
                        @if(\Illuminate\Support\Facades\Route::has('loan.index') && isset($core['pendingLoanRequests']))
                        ...
                        @endif
                        @if(\Illuminate\Support\Facades\Route::has('documentmanagement.document-requests.index') && isset($documents['documentManagement']) && $documents['documentManagement']['enabled'])
