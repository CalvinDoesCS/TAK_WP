        ...
        <div class="col-xl-8 col-lg-7 col-md-7">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    {{-- Attendance Metrics --}}
                    <h5 class="pb-3 border-bottom mb-3 mt-4">{{ __('Attendance Metrics') }}</h5>
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label class="form-label text-muted">{{ __('Late Hours') }}</label>
                            <p class="mb-0">
                                @if($attendance->late_hours > 0)
                                    <span class="badge bg-label-warning">
                                        <i class="bx bx-time-five"></i> {{ formatHours($attendance->late_hours) }}
                                    </span>
                                @else
                                    <span class="text-muted">{{ __('On Time') }}</span>
                                @endif
                            </p>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label text-muted">{{ __('Early Checkout') }}</label>
                            <p class="mb-0">
                                @if($attendance->early_hours > 0)
                                    <span class="badge bg-label-danger">
                                        <i class="bx bx-log-out"></i> {{ formatHours($attendance->early_hours) }}
                                    </span>
                                @else
                                    <span class="text-muted">{{ __('N/A') }}</span>
                                @endif
                        ...
                        <div class="col-md-4">
                            <label class="form-label text-muted">{{ __('Overtime') }}</label>
                            <p class="mb-0">
                                @if($attendance->overtime_hours > 0)
                                    <span class="badge bg-label-success">
                                        <i class="bx bx-plus-circle"></i> {{ formatHours($attendance->overtime_hours) }}
                                    </span>
                                @else
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label text-muted">{{ __('Shift Start Time') }}</label>
                            <p class="mb-0">
                                <i class="bx bx-time me-1"></i>
                        ...
                        <div class="col-md-6">
                            <label class="form-label text-muted">{{ __('Shift End Time') }}</label>
                            <p class="mb-0">
                                <i class="bx bx-time me-1"></i>
