    ...
    <div class="offcanvas-body">
      <form id="regularizationForm" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <small class="text-muted d-block mt-1" id="uploadNote" style="display: none;">
            {{ __('Upload new files to replace existing attachments.') }}
          </small>
        </div>
...
@vite('resources/assets/js/app/my-regularization.js')
@endsection
