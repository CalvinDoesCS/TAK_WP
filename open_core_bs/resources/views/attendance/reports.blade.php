        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <select id="reportPeriod" class="form-select">
              <option value="current_month" {{ ($period ?? 'last_3_months') === 'current_month' ? 'selected' : '' }}>{{ __('Current Month') }}</option>
              <option value="last_month" {{ ($period ?? 'last_3_months') === 'last_month' ? 'selected' : '' }}>{{ __('Last Month') }}</option>
              <option value="last_3_months" {{ ($period ?? 'last_3_months') === 'last_3_months' ? 'selected' : '' }}>{{ __('Last 3 Months') }}</option>
              <option value="last_6_months" {{ ($period ?? 'last_3_months') === 'last_6_months' ? 'selected' : '' }}>{{ __('Last 6 Months') }}</option>
              <option value="current_year" {{ ($period ?? 'last_3_months') === 'current_year' ? 'selected' : '' }}>{{ __('Current Year') }}</option>
              <option value="custom" {{ ($period ?? 'last_3_months') === 'custom' ? 'selected' : '' }}>{{ __('Custom Range') }}</option>
            </select>
          </div>
          <div class="col-md-4" id="customDateRange" style="display: {{ ($period ?? 'last_3_months') === 'custom' ? 'block' : 'none' }};">
          ...
          <div class="col-md-4 d-flex align-items-end gap-2">
            ...
            <button class="btn btn-label-secondary" id="resetFilter">
