      ...
      <div class="row g-3">
        ...
        <div class="col-md-4">
          ...
          <select class="form-select select2" id="teamFilter">
            ...
            @foreach(App\Models\Team::where('status', 'active')->get() as $team)
      ...
      <table class="table" id="leaveBalanceTable">
        <thead>
          <tr>
            ...
            <th>{{ __('Team') }}</th>
            @foreach(App\Models\LeaveType::where('status', 'active')->get() as $leaveType)
...
const pageData = {
  ...
  leaveTypes: @json(App\Models\LeaveType::where('status', 'active')->pluck('code', 'id'))
};
</script>
@endsection
