...
function loadEmployees() {
  ...
  function submitAppeal() {
    const warningId = $('#appeal_warning_id').val();
    const appealReason = $('#appeal_reason').val();
    const employeeStatement = $('#employee_statement').val();
    ...
    if (!appealReason.trim()) {
      Swal.fire({
        ...
        text: 'Please provide a reason for the appeal',
        customClass: {
    ...
    const $submitBtn = $('#submitAppealBtn');
