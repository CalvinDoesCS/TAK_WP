...
import DashboardLayout, { TDashBoardPostTab } from '@/container/DashboardLayout'
...
`),
	...
	const renderContent = () => {
		...
		if (!posts.length) {
			return (
				<Empty className="rounded-lg px-5 py-8 text-center ring-1 ring-neutral-200" />
			)
		}

		return (
			<div className="-mx-4 -my-2 min-h-[60vh] overflow-x-auto sm:-mx-6 lg:-mx-8">
					...
					<table className="min-w-full divide-y divide-gray-300 dark:divide-neutral-600">
						<thead>
							<tr>
								<th
									scope="col"
									className="py-3.5 pl-4 pr-3 text-start text-sm font-normal capitalize text-neutral-600 sm:pl-0 dark:text-neutral-400"
								>
									{T.Post}
								</th>
								<th
						...
						<tbody className="divide-y divide-gray-200 dark:divide-neutral-600">
							{posts.map((item, index, arr) => {
								...
								return (
									<tr key={post.databaseId}>
										<td className="whitespace-nowrap py-4 pe-3 ps-4 text-sm sm:py-5 sm:ps-0">
											<Link href={postUrl} className="flex items-center">
												...
												<div className="ms-4">
													<div className="flex w-96 max-w-sm whitespace-normal font-medium text-gray-900 dark:text-neutral-200">
														<span
							...
							<tr>
								{getPostsOfViewerResult.data?.viewer?.posts?.pageInfo
									...
									<td
										colSpan={7}
										className="px-3 py-5 text-center text-sm font-medium text-primary-600 dark:text-primary-400"
									>
										<ButtonPrimary
				...
				<div className="px-4 sm:px-6 lg:px-8">
					<div className="sm:flex sm:items-center">
						<div className="sm:flex-auto">
							<h1 className="text-lg font-semibold capitalize text-gray-900 dark:text-neutral-200">
								{currentTab} {T['Posts']}
							</h1>
