    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                {{-- @can('hrcore.create-attendance-regularization') --}} {{-- PERMISSION TEMPORARILY DISABLED --}}
    ...
    <div class="offcanvas-body">
        <form id="regularizationForm" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div id="existingAttachments" class="mb-2" style="display: none;">
                    <div class="alert alert-info d-flex align-items-start" role="alert">
                        <i class="bx bx-info-circle me-2 mt-1"></i>
                        <div class="flex-grow-1">
                            <strong>{{ __('Current Attachments:') }}</strong>
                            <div id="attachmentsList" class="mt-2">
                                <!-- Existing attachments will be listed here -->
                            </div>
                            <small class="text-muted d-block mt-2">
                                {{ __('Upload new files below to add more attachments.') }}
                            </small>
                        </div>
                    </div>
                </div>
...
const pageData = {
    routes: {
        ...
        statistics: "{{ route('hrcore.attendance-regularization.statistics') }}",
