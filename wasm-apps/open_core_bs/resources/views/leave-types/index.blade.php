...
@section('content')
  ...
  @include('leave-types._add_or_update_leave_type')
  @include('leave-types._view_leave_type')
  ...
  <script>
    const pageData = {
      ...
      permissions: {
        create: @json(true), // Permission check disabled
        edit: @json(true), // Permission check disabled
        delete: @json(true) // Permission check disabled
      },
      labels: {
