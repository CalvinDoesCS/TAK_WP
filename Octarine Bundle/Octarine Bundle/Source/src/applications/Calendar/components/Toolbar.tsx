...
import { LayoutGrid, List, Columns, GalleryThumbnails } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
function Main() {
  return (
    <>
      <DraggableHandle className="flex items-center justify-between px-2 py-2.5 border-b bg-muted/50 z-50 pl-20">
