...
<header class="entry-header mb-2 md:mb-6 py-6 md:py-12">
	...
	<h1 class="entry-title text-2xl md:text-5xl font-extrabold leading-tight mb-1 break-all">
		<?php echo get_the_title($register_id); ?></h1>
	</div>
</header>
	...
	<div class="container mx-auto my-8 flex items-start flex-wrap md:flex-nowrap gap-6">
		<div class="post_content_wrapper no_active_sidebar">
			<?php
				...
				<form action="" name="signup_form" id="signup_form" class="standard-form flex flex-col gap-4" method="post" enctype="multipart/form-data">
					...
					<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
						...
						if(!empty($content)){
							...
							echo '<p>'.__( 'Registering for this site is easy. Just fill in the fields below, and we\'ll get a new account set up for you in no time.', 'buddypress' ).'</p>';
						}
						...
						<div class="register-section flex flex-col gap-2 border rounded p-4" id="basic-details-section">
							...
							<input type="text" name="signup_username" id="signup_username" value="" <?php //bp_form_field_attributes( 'username' ); ?>/>
							</div>
							<div class="flex flex-col gap-2">
							...
							<div class="flex gap-2 flex-wrap">
								...
								<style>.short>span{color:crimson;}.good > span{color:seagreen;}.strong > span{color:darkgreen;}.weak > span {color: orangered;}</style>
								</div>
								<div class="flex flex-col gap-2 flex-1">
						...
						<?php if ( bp_is_active( 'xprofile' ) ) : ?>
							...
							<div class="register-section flex flex-col gap-2 border rounded p-4" id="profile-details-section">
						...
						<div class="submit">
							<input type="submit" name="signup_submit" id="signup_submit" value="<?php _ex( 'Complete Sign Up','singn up button on register page', 'buddypress' ); ?>" />
						</div>
					...
					<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
						...
						<?php if ( bp_registration_needs_activation() ) : ?>
							<h3 class="heading"><span><?php _e('Activate your account','buddypress'); ?></span></h3>
							<p><?php _e( 'You have successfully created your account! To begin using this site you will need to activate your account via the email we have just sent to your address.', 'buddypress' ); ?></p>
						<?php else : ?>
							<h3 class="heading"><span><?php _e('Account creatd, login to your account','buddypress'); ?></span></h3>
